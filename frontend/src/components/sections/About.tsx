        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            {/* CTA */}
             ...
             <a href="/cv/cv-arturo.pdf"
              download
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-6 py-3 bg-violet-600 hover:bg-violet-500 text-white font-medium rounded-full transition-all duration-300 hover:shadow-lg hover:shadow-violet-500/25"
            >
              Descargar CV
